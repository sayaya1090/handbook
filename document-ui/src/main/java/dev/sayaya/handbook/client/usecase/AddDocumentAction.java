 ...
 *
 * <p><b>책임:</b> execute() 시 새 {@link dev.sayaya.handbook.domain.Document}를
 * {@link DocumentList} 끝에 추가하고, rollback() 시 해당 문서를 제거하여 Undo를 지원한다.</p>
 *
 * <p><b>의존관계:</b>
 * <ul>
 *   <li>{@link DocumentList} — 문서 목록 상태 갱신 대상</li>
 *   <li>{@link dev.sayaya.handbook.domain.Document} — 추가할 문서 객체</li>
...
public class AddDocumentAction implements Action {
    ...
    public AddDocumentAction(DocumentList documentList, Document newDoc) {
