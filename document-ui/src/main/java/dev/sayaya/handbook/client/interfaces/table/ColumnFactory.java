...
/**
 * TypeValue의 속성을 Handsontable 컬럼 정의로 변환하는 팩토리.
 *
 * <p><b>책임:</b> {@link TypeValue}의 속성 목록을 읽어 serial, effectDateTime, expireDateTime
 ...
 * <p><b>의존관계:</b>
 * <ul>
 *   <li>{@link TypeValue} — 컬럼 생성의 원본 타입 정보</li>
 *   <li>{@link dev.sayaya.handbook.domain.AttributeValue} — 동적 컬럼의 속성 정보</li>
...
public final class ColumnFactory {
    ...
    public static ColumnDef[] create(TypeValue type) {
     ...
     */
    public static ColumnDef[] create(TypeValue type, List<TypeValue> allTypes) {
