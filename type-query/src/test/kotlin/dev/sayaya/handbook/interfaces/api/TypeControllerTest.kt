...
class TypeControllerTest : BehaviorSpec({
    ...
    Given("기간 지정 타입 조회 API") {
        ...
        When("GET /workspaces/{id}/types?effect_date_time=&expire_date_time=를 호출하면") {
            Then("200 OK가 반환된다") {
                client.get()
                    .uri("/workspaces/$workspace/types?effect_date_time=2026-01-01T00:00:00Z&expire_date_time=2026-12-31T23:59:59Z")
    ...
    Given("전체 타입 조회 API") {
        ...
        When("GET /workspaces/{id}/types를 기간 없이 호출하면") {
            Then("200 OK가 반환된다") {
                client.get()
