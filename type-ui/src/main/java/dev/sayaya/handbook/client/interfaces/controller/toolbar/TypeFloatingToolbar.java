...
public class TypeFloatingToolbar implements IsElement<HTMLDivElement> {
    private final HTMLDivElement root = div().css("type-floating-toolbar", "visible").element();

    @Inject
    TypeFloatingToolbar(RemoveTypeButton removeBtn, NewVersionButton newVersionBtn) {
