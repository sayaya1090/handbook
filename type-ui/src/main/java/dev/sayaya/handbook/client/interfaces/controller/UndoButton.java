...
@Singleton
class UndoButton implements IconButtonElementBuilder<MdIconButtonElement, IconButtonElementBuilder.PlainIconButtonElementBuilder> {
    ...
    @Inject UndoButton(ActionManager mgr, Observable<Label> labels) {
        labels.subscribe(this::update);
        submit.onClick(evt-> mgr.undo());
    }
