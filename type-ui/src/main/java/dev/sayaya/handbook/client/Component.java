...
import dev.sayaya.handbook.client.usecase.RendererSubject;
import dev.sayaya.handbook.client.usecase.SharedModule;
import dev.sayaya.handbook.client.usecase.UriSubject;

import javax.inject.Singleton;

@Singleton
@dagger.Component(modules = { BoxElementModule.class, LanguageRepositoryModule.class, ApiModule.class, SharedModule.class })
public interface Component {
    CanvasElement canvas();
    UriSubject uri();
    RendererSubject renderer();
}
