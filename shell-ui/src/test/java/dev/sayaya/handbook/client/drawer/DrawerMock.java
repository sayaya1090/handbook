...
public class DrawerMock {
    public static final Menu[] menu = new Menu[] {
            Menu.builder()
                    ...
                    .script("js/scene1.js")
                    .tools(new Tool[] {
                            Tool.builder().title("menu1-tool1").uriRegex("menu1-tool1").order("BA").icon("fa-circle").iconType("sharp").build()
                    }).build(),
            Menu.builder()
                    .title("Menu 2")
            ...
            Menu.builder()
                    ...
                    .bottom(true)
                    .tools(new Tool[] {
                            Tool.builder().title("menu4-tool1").uriRegex("menu4-tool1").order("0A").icon("fa-user").iconType("sharp").build()
                    }).build()
    };
