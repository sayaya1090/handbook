...
public class DrawerMock {
    public static final Menu[] menu = new Menu[] {
        Menu.builder()
            ...
            .url("/menu1-tool1")
            .urls("^/menu1-tool1")
            .tool(Tool.builder().id("tool-0").title("menu1-tool1").order("BA").icon("fa-circle").iconType("sharp").build())
            .build(),
        Menu.builder()
            .title("Menu 2")
            ...
            .tool(Tool.builder().id("tool-1").title("menu2-tool1").order("AA").icon("fa-pen").iconType("sharp").build())
            .tool(Tool.builder().id("tool-2").title("menu2-tool2").order("AB").icon("fa-user").iconType("sharp").build())
            .build(),
        Menu.builder()
            .title("Menu 3")
            .order("1")
            ...
            .tool(Tool.builder().id("tool-3").title("menu3-tool1").order("1A").icon("fa-user").iconType("sharp").build())
            .tool(Tool.builder().id("tool-4").title("menu3-tool2").order("1B").icon("fa-user").iconType("sharp").build())
            .build(),
        Menu.builder()
            .title("Menu 4")
            .order("0")
            ...
            .urls("^/menu4-tool1")
            .bottom(true)
            .tool(Tool.builder().id("tool-5").title("menu4-tool1").order("0A").icon("fa-user").iconType("sharp").build())
            .build(),
