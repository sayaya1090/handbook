...
public class Application implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        components.drawerPresenter();
        components.menuRailPresenter();
        components.toolRailPresenter();
