...
sealed interface AttributeTypeDefinition {
    val baseType: AttributeType
    val constraints: Map<String, java.io.Serializable>
    ...
    companion object {
        ...
        data class ValueType (
            override val constraints: Map<String, java.io.Serializable> = emptyMap()
        ...
        data class FileType (
            ...
            override val constraints: Map<String, java.io.Serializable> = mapOf()
            init {
