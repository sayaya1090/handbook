...
| `DashboardRepository.timeline()` | `GET /workspace/{ws}/stats/timeline?from=&to=&interval=` | 시계열 통계 |
| `DashboardRepository.distribution()` | `GET /workspace/{ws}/stats/distribution` | 타입별 문서 분포 |
